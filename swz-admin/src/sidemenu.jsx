...
export default class SideMenu extends React.Component {
  ...
  render() {
    ...
    return (<Menu vertical size="huge">
        ...
        <Menu.Item href='http://softworkz.net/contact/' target='_blank'>
          {CloverAdminLang.sidemenu.support}
        </Menu.Item>
        {/* <Menu.Item>
          <Menu.Header>{CloverAdminLang.sidemenu.support}</Menu.Header>
          <Menu.Menu>
            <Menu.Item href='http://softworkz.net/documentation/' target='_blank'>
              {CloverAdminLang.sidemenu.documentation}
            </Menu.Item>
            <Menu.Item href='http://softworkz.net/documentation/faq/' target='_blank'>
              {CloverAdminLang.sidemenu.faq}
            </Menu.Item>
            <Menu.Item href='http://softworkz.net/contact/' target='_blank'>
              {CloverAdminLang.sidemenu.emailsupport}
            </Menu.Item>
          </Menu.Menu>
        </Menu.Item> */}
      </Menu>);
