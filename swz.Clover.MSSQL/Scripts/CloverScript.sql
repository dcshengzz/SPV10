...
BEGIN
	INSERT dbo.dwAppSettings(Name, Value, GroupName, ParamName, [Order], EditorType, IsHidden) VALUES (N'ApplicationName', N'Clover', N'Application settings', N'Name', 0, 0, 0)
