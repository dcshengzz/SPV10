...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2026-07-09 01:29:11.517', 
[Data]=N'{
  "dataModel": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2026-07-09 00:36:26.077', 
[Data]=N'[
  {
    "key": "container_3",
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2026-07-09 00:36:26.117', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "respdashboard",
  "lastUpdate": "2026-07-09T00:36:26.1052575+08:00",
  "isTemplate": false,
  "triggers": [],
  "dataMap": [],
  "dataColl": [
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2026-07-09 00:52:25.247', 
[Data]=N'{
    ...
    onPrintClick: function(args) {
        ...
        if (!emails || emails.trim() === "") {
            ...
            const invalidEmails = emails.split('','').filter(m => !emailRegex.test(m.trim()));
        ...
        formDataPrint.append(''formName'', formName);
        formDataPrint.append(''dlsi'', dlsi);
        formDataPrint.append(''respId'', respId ? respId : "");
        ...
        .then(response => {
            ...
            if (response.success) {
                ...
                if (args.component.refs.printModal) {
                    args.component.refs.printModal.close();
                }
            } else {
                alertify.error(Utils.encodeHTML(response.message));
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2026-07-09 01:33:49.353', 
[Data]=N'[
  {
    "key": "container_6",
    "data-buildertype": "container",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2026-07-09 01:33:49.367', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "QNN_DPLY",
  "lastUpdate": "2026-07-09T01:33:49.3662502+08:00",
