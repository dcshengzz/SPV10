...
'727e8793-3bbf-4779-9d5b-ec7f123d83b7', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'AccessReportSchedule-code.js', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2021-08-04 18:37:43.117', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2021-08-10 23:25:52.653', 
N'{
    ...
    getSchedule: function(id){
        var url = ''/setting/accessreportschedule/'' + encodeURIComponent(id);
        return fetch(url,
            {
    ...
    validateInput: function(data){
        ...
        if(data.receiver === undefined || data.receiver.trim() === ''''){
            ...
            var emailValid
            var emailArr = data.receiver.split('','');
    ...
    isSelected: function(value){
        return Boolean(value === true || value ===1 || value === ''1'' || String(value).toLowerCase() == ''true'' )
    },
    ...
    saveSetting: function(args){
        if(accessreportscheduleUserActions.validateInput(args.data)){
            ...
            formData.append(''isEnabled'', accessreportscheduleUserActions.isSelected(args.data.isEnable));
            formData.append(''email'', args.data.receiver);
            var url = ''/setting/saveaccessreportschedule/'';
            return fetch(url,
                {
                    credentials: ''same-origin'',
                    contentType: ''application/x-www-form-urlencoded; charset=UTF-8'',
            ...
            console.log(''saveSetting is valid.'');    
        }else{
...
'c326137e-9316-4c18-bf91-d4c4ebe245b1', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'AccessReportSchedule-settings.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2021-08-04 15:47:52.077', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2021-08-10 13:56:03.487', 
N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "lastUpdate": "2021-08-10T13:56:03.4878595+08:00",
  "isTemplate": false
}');
...
'fe90af42-f588-41c2-a2e4-39aea75965dd', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'AccessReportSchedule.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2021-08-04 15:47:52.047', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2021-08-10 13:56:03.443', 
N'[
  {
    "key": "breadcrumb_1",
            ...
            "children": [
              {
                ...
                "floated": "",
                "buttonType": "submit",
                "other-readOnlyConition": "data.structDivision !== undefined && data.structDivision !== ''''  ? true : false"
              },
              {
                "key": "button_2",
                "data-buildertype": "button",
...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-10 13:55:32.303', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "lastUpdate": "2021-08-10T13:55:32.3029222+08:00",
  "isTemplate": false,
  "securityGroup": ""
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-10 13:55:32.260', 
[Data]=N'[
  {
    "key": "header_1",
    "data-buildertype": "header",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-10 21:25:36.667', 
[Data]=N'{
  "dataModel": [
    {
    ...
    {
      "id": "d6bfeeb9-4891-41a4-a41d-a64889196fe0",
      "name": "dwAccessReportSchedule",
      "dbObjectName": "dwAccessReportSchedule",
      "schemaName": "",
      "attributes": [
        {
          "id": "3c64f958-d01a-46a2-8f77-0b109b94d599",
          "name": "CreatedBy",
          "type": "Guid",
          "typeId": 0,
          "isNullable": true,
        ...
        {
          "id": "440098af-8a8a-4531-93df-b56abb64df1e",
          "name": "CreatedDate",
          "type": "DateTime",
          "typeId": 0,
          "isNullable": true,
        ...
        {
          "id": "70cb1c05-c8e8-494d-a2e4-50ac5d3d76bf",
          "name": "Email",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
        ...
        {
          "id": "1037985e-d112-4841-ab69-5eb574091a0e",
          "name": "Id",
          "type": "Guid",
          "typeId": 0,
          "isNullable": false,
        ...
        {
          "id": "ce9965db-2bbd-479c-8570-5835101c46e3",
          "name": "IsEnabled",
          "type": "Boolean",
          "typeId": 0,
          "isNullable": true,
        ...
        {
          "id": "3dff27a5-2498-4deb-a096-bb70539bad70",
          "name": "ScheduleType",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
        ...
        {
          "id": "4395357c-718e-4a48-99ad-a4f51594876c",
          "referenceEntityId": "5c4f1d9c-fb7b-480e-8841-32633dfa8ad7",
          "name": "StructDivisionId",
          "typeId": 1,
          "isNullable": true,
        ...
        {
          "id": "144a796c-9b75-4ba6-9b9a-9642f990846e",
          "name": "UpdatedBy",
          "type": "Guid",
          "typeId": 0,
          "isNullable": true,
        ...
        {
          "id": "ee7448ff-c60a-49c5-ad5a-dd2aab9111c3",
          "name": "UpdatedDate",
          "type": "DateTime",
          "typeId": 0,
          "isNullable": true,
