...
-- CategoryList.json
-- CategoryList-settings.json
-- SwzCategoryList.json
-- SwzCategoryList-settings.json
-- QNN_CATEGORY.json
-- QNN_CATEGORY-settings.json
-- QNN_CATEGORY-code.js

-- Will UPDATE existing row(s) in dwMetadata for the following:
-- base.json

DELETE FROM [dwMetadata] WHERE [FileName]='CategoryList.json' AND [Folder]='metadata/forms';

DELETE FROM [dwMetadata] WHERE [FileName]='CategoryList-settings.json' AND [Folder]='metadata/forms';

DELETE FROM [dwMetadata] WHERE [FileName]='SwzCategoryList.json' AND [Folder]='metadata/forms';

DELETE FROM [dwMetadata] WHERE [FileName]='SwzCategoryList-settings.json' AND [Folder]='metadata/forms';

DELETE FROM [dwMetadata] WHERE [FileName]='QNN_CATEGORY.json' AND [Folder]='metadata/forms';

DELETE FROM [dwMetadata] WHERE [FileName]='QNN_CATEGORY-settings.json' AND [Folder]='metadata/forms';

DELETE FROM [dwMetadata] WHERE [FileName]='QNN_CATEGORY-code.js' AND [Folder]='metadata/forms';
...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-01-27 14:04:19.997', 
[Data]=N'{
  "common": {
