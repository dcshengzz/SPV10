...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-10-24 14:50:34.913', 
[Data]=N'{
        ...
        const revokeDelegationById = function(args, p) {
            ...
            Utils.postFormRequest("/respondent/revokedelegationbyid",formData).then(
                response => {
                    ...
                    Utils.getRequest("/respondent/viewdelegatelist", params).then( 
                        response => {
