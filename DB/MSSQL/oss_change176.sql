...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-09-09 17:02:19.470', 
[Data]=N'{
  "dataModel": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-09-09 17:11:22.290', 
[Data]=N'[
  {
    "key": "header_1",
      ...
      },
      {
        ...
        "children": [
          ...
          },
          {
            ...
            "other-visibleConition": "!(data.DataEditor && data.DataEditor.length > 0)"
          }
        ],
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-09-09 17:11:22.443', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "dplysampleowner",
  "lastUpdate": "2021-09-09T17:11:22.4043787+08:00",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-09-09 17:05:47.170', 
[Data]=N'{   
    ...
    deleteAllAssignment: function(args){
        ...
        var url = ''/deployment/deleteAllDataEditors'';
        fetch(url,
            {
            ...
            .then(response => {
                ...
                if (response.success) {
                    args.component.refs.dataEditorGv.refresh();
    ...
    deleteDplySampleOwner: function(args){
        ...
        gridSelectedIndexes.forEach( function(i) { 
            // ... do something with s ...
            sampleOwnerIds.push(gridItems[i].lsoId);
        } );
        
        if(!sampleOwnerIds.length){
                  Pace.stop();
                $(''body'').loadingModal(''destroy'');   
            return alertify.error("Please, select rows for deletion!");  
        }
        
        var formData = new FormData();
        formData.append(''dplyId'', dplyId);
        formData.append(''sampleOwnerIds'', sampleOwnerIds);        
        var url = ''/deployment/deleteDataEditor'';
        fetch(url,
            {
                credentials: ''same-origin'',
                contentType: ''application/x-www-form-urlencoded; charset=UTF-8'',
    ...
    saveDplySampleOwner: function(args){
        ...
        var data = args.data;
        if(!data.DataEditor)
            throw alertify.error("No Data Editor selected");  
