...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-20 14:13:43.747', 
[Data]=N'{
    init: function (args) {
        //--------------------------------------------
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-24 17:52:19.250', 
[Data]=N'[
  {
    "key": "container_5",
                  ...
                  },
                  {
                    ...
                    "children": [
                      ...
                      },
                      {
                        ...
                        "children": [
                          {
                            "key": "actionAddAllStatusSchedule",
                            "data-buildertype": "breadcrumb",
                            "items": [
                              {
                                "text": "Add All Status",
                          ...
                          {
                            "key": "actionRemoveAllStatusSchedule",
                            "data-buildertype": "breadcrumb",
                            "items": [
                              {
                            ...
                            "children": [
                              {
                                "key": "staticcontent_6",
                                "data-buildertype": "staticcontent",
                                "content": "<h5 class=\"ui header\">Include Tags</h5><p name=\"status\"><p/>",
                                "isHtml": true,
                                "other-visibleConition": ""
                              },
                              {
                                "key": "ddIncludeTagsSchedule",
                            ...
                            "children": [
                              {
                                "key": "staticcontent_7",
                                "data-buildertype": "staticcontent",
                                "content": "<h5 class=\"ui header\">Exclude Tags</h5><p name=\"status\"><p/>",
                                "isHtml": true,
                                "other-visibleConition": ""
                              },
                              {
                                "key": "ddExcludeTagsSchedule",
                                "data-buildertype": "dropdown",
                                "label": "",
                                "fluid": false,
                                "selection": true,
                    ...
                    "children": [
                      {
                        "key": "staticcontent_4",
                        "data-buildertype": "staticcontent",
                        "content": "<h5 class=\"ui header\">Status Filter</h5><p name=\"status\"><p/>",
                        "isHtml": true,
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-24 17:52:19.280', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "dplyMessages",
  "lastUpdate": "2023-04-24T17:52:19.2785918+08:00",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-24 17:49:36.820', 
[Data]=N'{
    init: function(args) { 
        ...
        try{
            Utils.loadingStart();
            Utils.getRequest("/tags/getRespActiveTags?dplyId=" + encodeURIComponent(dplyId))
            .then(response => {
                    if(response.success && response.item !== null) {
                        var result = response.item;
                        dplymessagesUserActions.rewriteDdTags(args, result);
                    }
                }, reason => {
                    if(reason === "TAGS_NOT_FOUND"){
    ...
    profileMailMergeToStatus: function(args){
        ...
        const ddIncludeTags = args.data.ddIncludeTagsSchedule ? args.data.ddIncludeTagsSchedule : [];
        const ddExcludeTags = args.data.ddExcludeTagsSchedule ? args.data.ddExcludeTagsSchedule : [];
        ...
        if(ddIncludeTags.length > 0 && ddExcludeTags.length > 0) {
            const found = ddIncludeTags.some(r=> ddExcludeTags.includes(r))
            if(found) {
        ...
        formData.append(''includeTags'', JSON.stringify(ddIncludeTags));
        formData.append(''excludeTags'', JSON.stringify(ddExcludeTags));
        ...
        Utils.postFormRequest("/deployment/profileMailMergeToStatus",formData).then(
            response => {
                ...
                CloverApp.API.setDataField("ddTagsSchedule",[]);
            }, reason => {
                console.error(reason);
                alertify.error(reason);
            }
    ...
    profileMailMergeToStatusImmediate: function(args){
        ...
        const ddIncludeTags = args.data.ddIncludeTags ? args.data.ddIncludeTags : [];
        const ddExcludeTags = args.data.ddExcludeTags ? args.data.ddExcludeTags : [];
        ...
        Utils.postFormRequest("/deployment/profileMailMergeToStatusImmediate", formData).then(
            response => {
                ...
                CloverApp.API.setDataField("ddTags", []);
            }, reason => {
                console.error(reason);
                alertify.error(reason);
            }
    ...
    rewriteDdTags: function(args, tags){
        ...
        CloverApp.API.changeModelControl(args, "ddIncludeTagsSchedule","data-elements", options);
        CloverApp.API.changeModelControl(args, "ddExcludeTagsSchedule","data-elements", options);
    },
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-20 15:35:33.487', 
[Data]=N'[
  {
    "key": "header_1",
    "data-buildertype": "header",
  ...
  },
  {
    ...
    "children": [
      ...
      },
      {
        ...
        "children": [
          {
            "key": "IncludeTagsStatic",
            "data-buildertype": "staticcontent",
            "content": "<div class=\"ui divider\"></div>\n<h5 class=\"ui header\">Include Tags:</h5><p name=\"status\"><p/>",
            "isHtml": true
          },
          {
            "key": "ExcludeTagsStatic",
            "data-buildertype": "staticcontent",
            "content": "<div class=\"ui divider\"></div>\n<h5 class=\"ui header\">Exclude Tags:</h5><p name=\"status\"><p/>",
            "isHtml": true
          }
        ],
        "other-visibleConition": "data.StatusCollection.length !== 0"
              ...
              },
              {
                ...
                "children": [
                  ...
                  },
                  {
                    "key": "staticcontent_5",
                    "data-buildertype": "staticcontent",
                    "content": "<h5 class=\"ui header\">Tags Filter</h5>",
                    "isHtml": true
                  },
                  {
                    "key": "ddTagsFilter",
                  ...
                  },
                  {
                    ...
                    "multiple": true,
                    "events": {},
                    "other-visibleConition": "data.ddTagsFilter == ''2'' || data.ddTagsFilter == ''3''"
                  }
                ]
              },
              {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-20 15:35:33.520', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "dplyMessage",
  "lastUpdate": "2023-04-20T15:35:33.517212+08:00",
  ...
  "dataMap": [
    ...
    {
      "id": "2141a948-1391-a2f9-04ea-2f4893625137",
      "attributeId": "b323f4e5-84a9-4af9-8520-0ecc8056b4e9",
      "isEditable": true,
      "isLoadable": true
    },
    {
      "id": "ff0dfcef-4676-e961-6479-62540940116d",
      "attributeId": "15c4e803-83d3-4f0e-9f33-9cb0618ddce5",
      "isEditable": true,
      "isLoadable": true
    }
  ],
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-20 15:40:48.303', 
[Data]=N'{
    init: function(args){
        ...
        if(args.data.IncludeTags && args.data.IncludeTags.length > 0){
            args.data.IncludeTags.forEach(
                (entry) => {
                    $("span[name=''IncludeTagsStatic''] > p[name=''status'']").append("<a class=''ui label''>" + entry + "</a>");
                });
        } else {
            $("span[name=''IncludeTagsStatic'']").hide();
        }
        
        if(args.data.ExcludeTags && args.data.ExcludeTags.length > 0){
            args.data.ExcludeTags.forEach(
                (entry) => {
                    $("span[name=''ExcludeTagsStatic''] > p[name=''status'']").append("<a class=''ui label''>" + entry + "</a>");
                });
        } else {
            $("span[name=''ExcludeTagsStatic'']").hide();
        }
        
        let dplyId = args.data.DplyId;
        try{
            Utils.loadingStart("Retrieving Tags");
            Utils.getRequest("/tags/getRespActiveTags?dplyId=" + encodeURIComponent(dplyId))
            .then(response => {
                    if(response.success && response.item !== null) {
                        var result = response.item;
                        dplymessageUserActions.rewriteDdTags(args, result);
                    }
                }, reason => {
                    if(reason === "TAGS_NOT_FOUND"){
                        console.log("There is no active response tags");
    ...
    updateProfileMailMerge: function(args){
        ...
        const ddTagsFilter = args.data.ddTagsFilter;
        let ddTags = args.data.ddTags ? args.data.ddTags : [];
        ...
        if(ddTagsFilter !== ''1'' && ddTags.length == 0) {
            alertify.error("Tags is required for include/exclude tags");
            validated = false;
        } else if (ddTagsFilter == ''1'') {
            ddTags = [];
        }
        ...
        formData.append(''emailFrom'', emailFrom ?? "");
        formData.append(''scheduledDate'', scheduledDate);
        formData.append(''tagsFilter'', ddTagsFilter);
        formData.append(''tags'', JSON.stringify(ddTags));
    ...
    rewriteDdTags: function(args, tags){
        let ddTags = tags;
        let selectedTags = args.data.Tags;
        const options = [];
        for(var i=0; i<ddTags.length; i++) {
            options.push( {
                key: i,
        ...
        CloverApp.API.changeModelControl(args, "ddTags","data-elements", options);
        CloverApp.API.setDataField("ddTags", selectedTags);
    },
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-25 16:34:19.860', 
[Data]=N'{
  "dataModel": [
    {
    ...
    },
    {
      ...
      "attributes": [
        ...
        {
          "id": "b678c7c9-b078-4347-93b1-75cfe5452af1",
          "name": "Tags",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
    ...
    },
    {
      ...
      "attributes": [
        ...
        {
          "id": "b323f4e5-84a9-4af9-8520-0ecc8056b4e9",
          "name": "ExcludeTags",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
        ...
        {
          "id": "15c4e803-83d3-4f0e-9f33-9cb0618ddce5",
          "name": "IncludeTags",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
    ...
    },
    {
      ...
      "attributes": [
        ...
        {
          "id": "94209e7e-6b8b-4a99-8896-4920cfedc99c",
          "name": "CcEmails",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
    ...
    },
    {
      ...
      "attributes": [
        ...
        {
          "id": "476c6dcd-62d2-475f-9974-d7d2305a4def",
          "name": "Tags",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
    ...
    },
    {
      ...
      "attributes": [
        ...
        {
          "id": "2184b443-3203-414d-afe9-a3eea0f41675",
          "name": "CcEmails",
          "type": "String",
          "typeId": 0,
          "isNullable": false,
    ...
    },
    {
      ...
      "attributes": [
        ...
        {
          "id": "816d6414-c0f4-4788-8952-2efaa911371f",
          "name": "Tags",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
    ...
    {
      "id": "c8283ca5-acff-489d-8503-cf60d2759f06",
      "name": "vSP_RespTagsWithDplyId",
      "dbObjectName": "vSP_RespTagsWithDplyId",
      "schemaName": "",
      "attributes": [
        {
          "id": "99e6f149-7294-41d9-839f-faa2b08ef02d",
          "name": "DplyId",
          "type": "Guid",
          "typeId": 0,
          "isNullable": true,
        ...
        {
          "id": "187cbc3c-719d-4c4c-b5e6-050432c515c0",
          "name": "Tags",
          "type": "String",
          "typeId": 0,
          "isNullable": true,
