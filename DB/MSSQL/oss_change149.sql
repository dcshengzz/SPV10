...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-12 13:05:20.870', 
[Data]=N'{
  "dataModel": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-11 19:56:01.243', 
[Data]=N'[
  {
    "key": "container_6",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-12 11:43:05.457', 
[Data]=N'{
    init: function(args) {
    ...
    dropdownQuestionnaireOnChange: function(args) {
        var qnnId = args.data.dictQuestionnaire;
        if(args.data.textSurveyName=="" || args.data.textSurveyName ==null){
            var url = ''/deployment/getQuestionnaireTitle?id='' + qnnId;
            return ()=>{
                return fetch(url,
                    {
                        credentials: ''same-origin'',
                    ...
                    .then(response => {
                        if (response.success) {
                            CloverApp.API.setDataField("textSurveyName", response.title);
                        } // end if response.success        
                    }) // end then => response
            }; //end return
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-11 19:56:01.270', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "QNN_DPLY",
  "lastUpdate": "2021-08-11T19:56:01.2706278+08:00",
