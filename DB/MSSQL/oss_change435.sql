...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-11-04 23:50:31.690', 
[Data]=N'[
  {
    "key": "frm_Recurrence",
    ...
    "children": [
      {
        ...
        "children": [
          ...
          },
          {
            ...
            "children": [
              {
                "key": "message_2",
                "data-buildertype": "message",
                "header": "Sample Owner Import Upload",
                "content": "Select a csv file with the sample owner data to transfer to the server. A background job will immediately (NO CONFIRMATION DIALOG!) be queued to process the data file on the server and you will be notified of the outcome by email.",
                "info": true
              },
              {
                "key": "SampleOwnerUpload",
                "data-buildertype": "input",
                "label": "",
                "fluid": true,
                "onChangeTimeout": 200,
            ...
            "style-source": "border: 1px solid black;\npadding: 20px;",
            "other-visibleConition": "data.SampleOwnerUpload == null || data.SampleOwnerUpload == \"\""
          },
          {
            "key": "container_1",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-11-04 23:50:31.857', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "dplyMaintenance",
  "lastUpdate": "2023-11-04T23:50:31.839196+08:00",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-11-04 09:28:30.810', 
[Data]=N'{
    init: function(args) {
