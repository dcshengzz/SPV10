...
'19041752-6906-489c-adeb-ffd77ce10627', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'ShortLink.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-20 14:04:44.143', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-24 16:06:01.600', 
N'[
  {
    "key": "form_1",
    ...
    "children": [
      ...
      },
      {
        ...
        "onChangeTimeout": 200,
        "other-required": true,
        "other-customValidation": "(value!=null && value.length>0 && value.length<=300) ? true : \"must be <=300 characters in length!\"",
        "style-width": ""
      },
      {
        "key": "Description",
        ...
        "other-customValidation": "((value==null) || (value.length <= 2048)) ? true : \"must be <=2048 characters in length!\""
      },
      {
        "key": "formgroup_1",
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "key": "formgroup_deploymentDetails",
            "data-buildertype": "formgroup",
            "widths": "equal",
            "children": [
              {
                ...
                "columns": "Name ASC",
                "dataModel": "QNN_DPLY",
                "filters": "[ { \"column\" : \"IsAnonymous\" , \"value\" : \"1\" , \"term\" : \"=\" } ]",
                "search": true,
                "events": {
                  "onChange": {
                    "active": true,
                ...
                "other-customValidation": "((\"Anonymous\" != data.LinkType) || (\"Anonymous\"==data.LinkType && value != null && value != \"\")) ? true : \"is required!\"",
                "reference": "Deployment",
                "placeholder": "Select an Anonymous Survey"
              },
              {
                "key": "FormName",
                ...
                "reference": "Form",
                "placeholder": "Select the Form / Language"
              }
            ],
            "other-visibleConition": "(\"Anonymous\"==data.LinkType)"
          },
          {
            "key": "formgroup_urlDetails",
            "data-buildertype": "formgroup",
            "widths": "equal",
            "children": [
              {
                ...
                "onChangeTimeout": 200,
                "other-visibleConition": "",
                "other-customValidation": "(\"Url\" != data.LinkType) || ( (\"Url\" == data.LinkType) && (value != null) && (value.trim().length>0 && value.length <= 1024)) ? true : \"is required and must be <=1024 characters in length!\"",
                "placeholder": "https://www.example.com/"
              }
            ],
            "other-visibleConition": "(\"Url\"==data.LinkType)"
          }
        ],
...
'4b3767e2-2251-46fd-b68c-6f6a5f4408c9', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'ShortLink-settings.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-20 14:04:44.173', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-24 16:06:01.713', 
N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "ShortLink",
  "lastUpdate": "2022-10-24T16:06:01.7031316+08:00",
...
'd046330a-51b1-40e2-bdea-fba77e12c3be', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'ShortLink-code.js', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-20 14:32:54.637', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-24 15:41:15.480', 
N'{
    init: function(args) {
            ...
            response => {
                ...
                document.getElementsByName("btnCopy-shortlink").forEach(function(btn){
                   btn.addEventListener("click",function(e){
                       ...
                       alertify.success("Copied to clipboard: " + item.url);
                   })
                });
            }, reason => {
                console.error(reason);
                alertify.error("Failed to load QR Code: " +  reason);
            }
        ).finally(Utils.loadingStop);
    },
...
'1c86fa2a-372d-4843-ac3f-d02fcc008549', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'ShortLinkList.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-20 17:27:41.197', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-24 15:30:25.213', 
N'[
  {
    "key": "container_1",
    "data-buildertype": "container",
...
'8465a612-1d81-4743-9c5e-2ba92dfdae5e', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'ShortLinkList-settings.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-20 17:27:41.247', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-24 15:30:25.243', 
N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "ShortLinkList",
  "lastUpdate": "2022-10-24T15:30:25.2446886+08:00",
  "isTemplate": false,
  "triggers": [],
  "dataMap": [],
  "dataColl": [
...
'6fa02689-c412-403c-9eb8-4fb77613d42e', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'ShortLinkList-code.js', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-20 17:32:46.187', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-10-24 15:30:59.743', 
N'{
...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-10-24 13:55:55.647', 
[Data]=N'{
  "dataModel": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-10-21 20:52:27.740', 
[Data]=N'[
  {
    "key": "sidemenu",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-10-21 20:52:27.787', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "lastUpdate": "2022-10-21T20:52:27.78659+08:00",
  "isTemplate": false
