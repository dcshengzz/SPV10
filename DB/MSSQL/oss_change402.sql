...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-05-18 17:16:11.930', 
[Data]=N'[
  {
    "key": "container_3",
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-05-22 15:26:34.170', 
[Data]=N'{
    ...
    init: function(args){
        ...
        const genFormLink = function(p, elements, languages, formName, index){
            ...
            if(languages.length-1 !== index) {
                elements.push( CloverApp.API.createElement("span",{},", ") );
            }
        ...
        const formColumnFormatter = function (p) {
            if(p.row.Type=="Online"){
                ...
                //genFormLink.bind(null, p, elements, languages);
        ...
        const excelButtonFormatter = function(p) {
            ...
            const icon = CloverApp.API.createElement("i", {className: "upload excel icon",ariaHidden: "true" }, "");
            const btn = CloverApp.API.createElement(
                "button", {
                    onClick: () =>  checkAccessCode(innerArgs, p, '''', ''upload''), 
                    className: iconBtnClass , style: { color: "black" }}, icon);
        ...
        const printColumnFormatter = function (p) {
            ...
            const btn = CloverApp.API.createElement("button", { onClick: () => checkAccessCodeForPrint(innerArgs, p), className: iconBtnClass , style: { color: "black" }},icon);
            return CloverApp.API.createElementWithPopup(btnText,popupProps,btn); 
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-05-18 17:16:11.953', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "respdashboard",
  "lastUpdate": "2023-05-18T17:16:11.9526315+08:00",
  "isTemplate": false,
  "triggers": [],
  "dataMap": [],
  "dataColl": [
