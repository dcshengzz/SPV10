-- Adds the DataOnData and ValidationDplyId columns to QNN_DPLY and fields in the form
  ...
  "dataModel": [
    ...
    },
    {
      ...
      "attributes": [
        ...
        {
          "id": "f5f0bb60-f187-47d8-96c9-ef14cfb874d8",
          "name": "DataOnData",
          "type": "Boolean",
          "typeId": 0,
          "isNullable": false,
...
UPDATE dbo.dwMetadata SET Folder = N'metadata/forms', Filename = N'QNN_DPLY.json', IsDeleted = 0, CreatedBy = '540E514C-911F-4A03-AC90-C450C28838C5', CreatedDate = convert(datetime, '2019-03-28 21:49:21.393', 120), DeletedBy = NULL, DeletedDate = NULL, UpdatedBy = 'B9D69BA9-282B-D3D2-8F23-EFC2596A082C', UpdatedDate = convert(datetime, '2020-09-09 16:44:21.637', 120), Data = N'[
  {
    "key": "container_6",
  ...
  },
  {
    ...
    "children": [
      ...
      },
      {
        "key": "DataOnData",
        "data-buildertype": "checkbox",
        "label": "Enable Data on Data Validation",
        "toggle": true,
        "events": {
          "onChange": {
            "active": true,
            "actions": [
              "clearValidationDplyId"
            ],
            "targets": [],
            "parameters": []
          }
        ...
        "children": [
          {
            ...
            "events": {},
            "dataModel": "QNN_DPLY",
            "other-visibleConition": "data.DataOnData ? true : false",
            "columns": "Name ASC"
          }
        ]
      }
...
UPDATE dbo.dwMetadata SET Folder = N'metadata/forms', Filename = N'QNN_DPLY-code.js', IsDeleted = 0, CreatedBy = '540E514C-911F-4A03-AC90-C450C28838C5', CreatedDate = convert(datetime, '2019-03-28 21:49:21.290', 120), DeletedBy = NULL, DeletedDate = NULL, UpdatedBy = 'B9D69BA9-282B-D3D2-8F23-EFC2596A082C', UpdatedDate = convert(datetime, '2020-09-09 16:45:34.067', 120), Data = N'{
...
//        CloverApp.API.setDataField("invalidQnnColumns",[''A11'', ''B22'', ''C33'']);
  ...
  var _loadingStart = function() {
    ...
    clearValidationDplyId: function(args) {
        if(!args.data.DataOnData) {
            CloverApp.API.setDataField("ValidationDplyId",null);
        }
    },
...
UPDATE dbo.dwMetadata SET Folder = N'metadata/forms', Filename = N'QNN_DPLY-settings.json', IsDeleted = 0, CreatedBy = '540E514C-911F-4A03-AC90-C450C28838C5', CreatedDate = convert(datetime, '2019-03-28 21:49:21.340', 120), DeletedBy = NULL, DeletedDate = NULL, UpdatedBy = 'B9D69BA9-282B-D3D2-8F23-EFC2596A082C', UpdatedDate = convert(datetime, '2020-09-09 16:44:21.703', 120), Data = N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "QNN_DPLY",
  "lastUpdate": "2020-09-09T16:44:21.7041531+08:00",
  ...
  "dataMap": [
    ...
    {
      "id": "6828e8e6-751c-08f5-03fe-dbd39edbd253",
      "attributeId": "f5f0bb60-f187-47d8-96c9-ef14cfb874d8",
      "isEditable": true,
      "isLoadable": true
    },
    {
