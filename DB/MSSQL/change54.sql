--fix newly created sample does not appear in the samples grid if it is not active
--fix rollback spSP_GetRespAnsWithDetails to use pivot and left join status table instead of inner join
