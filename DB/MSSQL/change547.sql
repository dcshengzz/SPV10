-- change547.sql is Hangfire's DefaultInstall.sql for HangFire 1.8 downloaded 2025-01-03
-- renamed as a numbered script to indicate when it should be run as part of a a build update
-- Source: https://github.com/HangfireIO/Hangfire/blob/858f19dfa5fd5fb5b95fe20f9c3f841a7ba658b2/src/Hangfire.SqlServer/DefaultInstall.sql
-- See also: https://docs.hangfire.io/en/latest/upgrade-guides/upgrading-to-hangfire-1.8.html
