...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-12-08 18:28:59.800', 
[Data]=N'{
     init: function(args){
        CloverApp.API.setDataField("NewValue", JSON.stringify(args.data.NewValue,null,"\t"));
        CloverApp.API.setDataField("OldValue", JSON.stringify(args.data.OldValue,null,"\t"));
