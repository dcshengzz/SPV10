...
'7cb209ee-3094-4ef1-b530-74ca26baba6f', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplyValidation.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2020-09-12 13:45:29.520', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2020-09-22 14:18:04.880', 
N'[
  {
    "key": "importValidationData",
...
'1368be1e-8bfc-4117-a850-e85f5c71f9b6', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplyValidation-settings.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2020-09-12 13:45:30.087', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2020-09-22 14:27:55.797', 
N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "dplyValidation",
  "lastUpdate": "2020-09-22T14:27:55.7886874+08:00",
...
'ec448626-827e-4932-bd3a-bba8de7146dd', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplyValidation-code.js', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2020-09-12 13:54:21.950', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2020-09-22 12:02:38.823', 
N'{
    init: function(args) {
        ...
        CloverApp.API.rewriteControlModel("UploadDataset", model => {
            ...
            model.onUploadEnd = (cmp, ok) => { loadingStop(); if(!ok) { alertify.error("File upload failed"); } };
        });
    },
    ...
    onImport: function(args) {
        ...
        if("FAIL"==result) {
            ...
            alertify.error("A UID column is required");
        } else if("OK"==result) {
            alertify.success("Data imported");
            gridview.refresh();
        }
    ...
    fooButton: function(args) {
        console.log("fooButton args", args);  
        
        
        const gridview = args.component.refs.gv_Datasets;
        gridview.refresh();
        console.log("refreshed gv", gridview);
...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2020-09-22 11:11:30.693', 
[Data]=N'[
  {
    "key": "container_6",
    "data-buildertype": "container",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2020-09-22 13:53:51.303', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "QNN_DPLY",
  "lastUpdate": "2020-09-22T13:53:51.3000945+08:00",
  "entityId": "95d26a40-bf59-4aef-b578-12b2535f7789",
  "isTemplate": false,
  "triggers": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2020-09-22 11:11:14.720', 
[Data]=N'{
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2020-09-22 13:53:24.003', 
[Data]=N'{
  "dataModel": [
    {
