...
'967fd08d-4fee-4d24-ac0e-afe1dca6abbf', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplyMaintenance.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-11-02 15:03:40.110', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-11-02 15:07:34.797', 
N'[
  {
    "key": "frm_Recurrence",
            ...
            "children": [
              {
                ...
                "content": "Select a csv file with the previously exported response data to transfer to the server. A background job will immediately be queued to process the data file on the server and you will be notified of the outcome by email.",
                "info": true
              },
              {
                "key": "ResponseUpload",
...
'6a20fa57-ecb9-407a-801c-6e8b8e4f7c86', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplyMaintenance-settings.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-11-02 15:03:40.190', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-11-02 15:07:34.847', 
N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "dplyMaintenance",
  "lastUpdate": "2023-11-02T15:07:34.8467305+08:00",
...
'0c290d6f-5456-4ab4-913f-12cd3a456147', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplyMaintenance-code.js', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-11-02 15:04:38.950', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-11-02 15:51:32.190', 
N'{
    init: function(args) {
        ...
        CloverApp.API.rewriteControlModel("ResponseUpload", model => {
            ...
            model.onUploadEnd = (ctrl, success, xhr, msg, err) => {
                ...
                if(!success) {
                    ...
                    if(xhr.status=== 400) {
                        alertify.error("Upload Failed - " + xhr.statusText + " - " + xhr.responseText, 30000);
                    } else if(xhr.status===413) {
                        alertify.error("Upload Failed - the selected file is too large to be uploaded here", 30000);
                    } else {
                        alertify.error("Upload Failed - " + msg + " - " + err, 30000);
                    }
                } else {
                    console.error(xhr.message);
                    if("OK" == xhr.message) {
                        alertify.success("File transferred to server, you will be notified by email when processing is complete", 30000);
                    } else if("FAIL" == xhr.message) {
                        alertify.error("Failed to transfer the file to the server.", 30000);
                    } else {
                        alertify.error("This file is not valid. Please check that you have the correct file.", 30000);
                    }
                }
            }
        });  
...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-11-02 15:05:58.400', 
[Data]=N'[
  {
    "key": "container_6",
    "data-buildertype": "container",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-11-01 14:46:07.967', 
[Data]=N'{
    init: function(args) {
        if(!args.data.Id){
