...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-04-19 16:22:42.393', 
[Data]=N'{
    ...
    init: function(args){
        ...
        //--------------------------------------------
        const redirectToPrintSurvey = function(dlsi, formName, respId) {
        ...
        const genFormLink = function(p, elements, languages, formName, index){
            ...
            if(ipIsAllowed) {
                ...
                const icon = CloverApp.API.createElement("i", {className: "print icon",ariaHidden: "true" }, "");
                elements.push(
                    CloverApp.API.createElement("button", {onClick: ()=> checkAccessCode(innerArgs, p, formName, ''print'') , className: iconBtnClass }, icon)
                );
            ...
            try {
                ...
                const performAction = function() {
                    if(control == ''form''){
                        ...
                        redirectToPrintSurvey(dlsi,formName,respId);
                    }
                };
