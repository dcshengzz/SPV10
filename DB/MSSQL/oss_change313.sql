...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-05-24 22:31:06.410', 
[Data]=N'{
  "dataModel": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-05-24 18:31:34.290', 
[Data]=N'{
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-05-24 21:45:25.497', 
[Data]=N'[
  {
    "key": "header_1",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-05-24 21:19:19.570', 
[Data]=N'{
    init: function(args){
        console.log(args);
    ...
    editEmailToStatus: function(args){
        ...
        var url = "";
        if(status.length !== 0 && listSampleIds.length ==0){
            url = "/deployment/emailtostatus";
            formData.append(''status'', status);
        } 
        if(listSampleIds.length !== 0 && status.length ==0){
            url = "/deployment/resend";
            formData.append(''listSampleIds'',listSampleIds);
        ...
        if(validated){
            ...
            Utils.postFormRequest(url,formData).then(
                response => {
                    ...
                    console.log("Error 123 message",reason);
                    alertify.error(reason);
                }
            ).finally(Utils.loadingStop);
        }
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-05-24 21:45:25.523', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "dplyMessage",
  "lastUpdate": "2022-05-24T21:45:25.5124866+08:00",
