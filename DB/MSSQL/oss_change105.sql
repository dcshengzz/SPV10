...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-07-05 23:21:56.720', 
[Data]=N'[
  {
    "key": "header_1",
                    ...
                    "children": [
                      {
                        "key": "staticcontent_5",
                        "data-buildertype": "staticcontent",
                        "content": "This survey is protected. Please enter the survey specific access or delegation code to upload survey response.<br/>",
                        "isHtml": true
                      }
                    ]
                  },
                  {
                    "key": "UploadAccessCode",
                    "data-buildertype": "input",
                    "label": "",
                    "fluid": true,
                    "onChangeTimeout": 200,
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-07-05 23:21:57.420', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "respdashboard",
  "lastUpdate": "2021-07-05T23:21:57.4181671+08:00",
  "isTemplate": false,
  "triggers": [],
  "dataMap": [],
  "dataColl": [
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-07-06 10:37:51.090', 
[Data]=N'{
...
console.log("Args", args);
                ...
                cols.Actions.customFormatter = function (p) {
                    ...
                    if(hasOnlineFiles && ipAllowed && (status==PENDING || status==IN_PROGRESS) ){
                        ...
                        return CloverApp.API.createElement(
                            "button", {
                                onClick: () => openUploadModal(innerArgs, p.row.QnnId, p.row.DplyId, p.row.ListSampleId, formNames, languages, p.row.Id, p.row.RequireAccessCode), 
       ...
       /* var genFormLinks = function(p, elements, languages, value, index){
        ...
        var openUploadModal = function(innerArgs, qnnId, dplyId, listSampleId, formNames, languages, dlsi, requireAccessCode) {
            //console.log("innerArgs, qnnId, dplyId, listSampleId", innerArgs, qnnId, dplyId, listSampleId);
            
            CloverApp.API.setDataField("UploadAccessCode", "");
            args.data.UploadAccessCode = null;
            const accessCode = "";
            
            CloverApp.API.rewriteControlModel("ExcelFileUpload", model => {
                model.customPostUrl = "/respondent/uploadexcelresponse?" + new URLSearchParams( { dlsi, qnnId, dplyId, listSampleId, accessCode } );
            ...
            CloverApp.API.setDataField("UploadRequireAccessCode", requireAccessCode);
            
            var control = innerArgs.state.app.form.models.hideControls;
            const controlIndex = control.indexOf("UploadAccessCodeForm");
            if (controlIndex > -1) {
                control.splice(controlIndex, 1);
            }
            if (!requireAccessCode) {
                control.push("UploadAccessCodeForm");
            } 
    ...
    uploadAccessCodeOnChange: function (args) {
        // rewrite the customPostUrl for ExcelFileUpload on input access code changes
        const qnnId = args.data.UploadQnnId;
        const dplyId = args.data.UploadDplyId;
        const listSampleId = args.data.UploadListSampleId;
        const accessCode = args.data.UploadAccessCode;
        const dlsi = args.data.UploadDlsi;
    ...
    promptForExcelFile: function(args) {
        const accessCode = args.data.UploadAccessCode;
        const requireAccessCode = args.data.UploadRequireAccessCode;

        if(requireAccessCode){
            if(accessCode===undefined || accessCode===null || accessCode==='''') {
                throw new alertify.error("Please provide your access code to upload survey response", 10000);
            }
        }
    ...
    excelFileUploaded: function(args) {
        ...
        if("OK"===result) {
            ...
            const uploadDlsi = args.data.UploadDlsi;
            args.component.refs.grid.refresh();
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-06-30 16:31:01.450', 
[Data]=N'[
  {
    "key": "form_1",
    "data-buildertype": "form",
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-06-30 16:31:01.520', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "DataEditorDeployment",
  "lastUpdate": "2021-06-30T16:31:01.5195713+08:00",
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-06-30 16:50:25.843', 
[Data]=N'{
    init: function (args) {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-06-30 18:13:00.853', 
[Data]=N'[
  {
    "key": "header_1",
    "data-buildertype": "header",
        ...
        "children": [
          {
            ...
            "secondary": true,
            "other-visibleConition": "checkRole(''SurveyAdmin'')"
          }
        ],
        "style-source": ""
      },
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-06-30 18:13:00.897', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "AuditTrail",
  "lastUpdate": "2021-06-30T18:13:00.8958683+08:00",
  "isTemplate": false,
  "triggers": [],
  "dataMap": [],
  "dataColl": [
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-07-01 14:17:00.343', 
[Data]=N'{
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-06-30 15:49:23.723', 
[Data]=N'[
  {
    "key": "subject",
    "data-buildertype": "staticcontent",
