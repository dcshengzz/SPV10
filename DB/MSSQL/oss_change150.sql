...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-12 18:20:17.413', 
[Data]=N'{
  "dataModel": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-12 17:40:16.270', 
[Data]=N'{
    init: function (args) {
        ...
        const resetFormatter  = function (p) {
            ...
            if(p.row.StatusCode==''DE'' || p.row.StatusCode==''SB'' || p.row.StatusCode==''CL''){
                const btn = CloverApp.API.createElement("button", { onClick: () => resetStatus(innerArgs, p.row.Id), className: iconBtnClass },icon);
                element = CloverApp.API.createElementWithPopup(btnText,popupProps, btn);
            }
            else{
                const btn = CloverApp.API.createElement("button", {className: iconBtnDisabledClass },icon);
        ...
        const xlsxActionsFormatter = function (p) {
            ...
            if(showUploadButtonInAppropriateStatus) {
                ...
                if(!excelEnabledForDply && !alwaysShowForDataEditor) {
                    ...
                    const btn = CloverApp.API.createElementWithPopup(uploadButtonText, "button", {className: iconBtnDisabledClass }, uploadIcon);
                    const container = CloverApp.API.createElement("div", {},  btn);
            ...
            if(p.row.IsExcelResponse) {
                ...
                element = CloverApp.API.createElement("a", 
                    ...
                    responseLinkText);      
                const marginDiv = CloverApp.API.createElement("div", {style:{marginTop:"4px"} },element );      
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-12 11:30:08.123', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "DataEditorDeployment",
  "lastUpdate": "2021-08-12T11:30:08.1218215+08:00",
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-12 11:30:08.047', 
[Data]=N'[
  {
    "key": "form_1",
