...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-09-21 10:20:37.967', 
[Data]=N'[
  {
    "key": "header_1",
        ...
        "children": [
          {
            ...
            "header": "Pre-populate Info",
            "content": "Pre-populate will populate response data to current deployment. \nIf the deployment have existing pre-populated data it will be remove and replace with new set of pre-populate data. \nPre-populate data to sample will be ignore if the sample have any sample response.",
            "info": true
          },
          {
            "key": "PrePopulateInfo",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-09-21 10:20:38.007', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "QNN_DPLY_PRE_POPULATE",
  "lastUpdate": "2021-09-21T10:20:38.0069615+08:00",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-09-20 22:56:23.030', 
[Data]=N'{
    init: function(args){
        //-----------------------
        ...
        CloverApp.API.rewriteControlModel("CsvFileUploaded", model => {
            ...
            model.onUploadBegin = () => loadingStart("Pre-populating...");
            model.onUploadEnd = loadingStop;
        });
    },
    
    getDeploymentFields: function(args){
        var dplyId = args.controlRef.props.value;
        ...
        var url = ''/deployment/getDeploymentFields'';
        fetch(url,
            {
    ...
    addAllFields: function(args){
        var allFields = args.data.DeploymentQnnFields;
        if(allFields != null) {
    ...
    csvFileUploaded: function(args) {
        ...
        if("OK"===result) {
            ...
            if("FAIL" == result){
                ...
                errorMessage = "Uploaded file contains duplicate header. Please remove duplicate header and try again."
            } else if ("NO ALIAS COLUMN" == result){
                errorMessage = "Uploaded file do not have valid alias for this deployment. Do you select the correct CSV file?"
