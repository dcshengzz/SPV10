...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2024-08-16 18:45:44.697', 
[Data]=N'{
          ...
          if (ipIsAllowed) {
            ...
            if (isMultipleResponse) {
              ...
              if (showActionAdd) {
                ...
                const viewLinkClass = status === SUBMITTED ? "link-style" : "disabled-link";
                ...
                formControls.push( 
                    ...
                    CloverApp.API.createElementWithPopup("View Response", popupProps,
                        CloverApp.API.createElement("span", { onClick: onClickForm, className: viewLinkClass , style: { /*color: "red",*/ paddingLeft: "0.5em" } },
                        [
                            CloverApp.API.createElement("i", {className: "eye icon", ariaHidden: "true" }, "")
                        ]))
                );
...
[CreatedBy]='540e514c-911f-4a03-ac90-c450c28838c5', [CreatedDate]='2019-03-28 21:49:00.000', 
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2024-08-16 18:38:28.943', 
[Data]=N'[
  {
    "key": "container_3",
