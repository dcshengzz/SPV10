...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-05 12:07:31.380', 
[Data]=N'[
  {
    "key": "container_4",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-05 12:07:31.447', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "SwzDplyList",
  "lastUpdate": "2021-08-05T12:07:31.4480984+08:00",
  "isTemplate": false,
  "triggers": [],
  "dataMap": [],
  "dataColl": [
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2021-08-05 12:45:20.653', 
[Data]=N'{
    init: function (args) {
        const respCountFormatter = function (p) {
            ...
            const content = hasAnyResponses
                ...
                CloverApp.API.createElement("a", {
                        href: "/deployment/download/resp/" + encodeURIComponent(p.row.Id) + "/" + encodeURIComponent(p.row.QnnId), 
                        target: "_blank", 
