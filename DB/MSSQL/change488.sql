...
'dfb3c8d0-e0e1-4a77-8fd7-cf3343a6fcfd', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplySnapshot.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2024-06-16 18:24:00.087', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2024-06-17 12:03:16.490', 
N'[
  {
    "key": "form_ReportSnapshot",
    ...
    "children": [
      ...
      },
      {
        ...
        "children": [
          {
            ...
            "multiple": true,
            "clearable": true,
            "other-customValidation": "((data.rs_EmailOnSuccess || data.rs_EmailOnFailure) && (value==null || value.length==0)) ? \"required for sending notifications\" : true;",
            "reference": "Email Recipients"
          },
          {
            "key": "formgroup_email",
            ...
            "children": [
              {
                "key": "rs_EmailOnSuccess",
                "data-buildertype": "checkbox",
                "label": "Email on Success",
                "toggle": true
              },
              {
                "key": "rs_EmailOnFailure",
                "data-buildertype": "checkbox",
        ...
        "other-visibleConition": "Utils.isSelected(data.rs_SaveSnapshot)",
...
'f9e0b630-92ee-4722-b2f9-a426eda90b69', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplySnapshot-code.js', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2024-06-16 18:46:08.650', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2024-06-17 20:06:27.503', 
N'{
    init: function(args) {
        ...
        Utils.getRequest("/report/snapshot/settings?dplyId=" + encodeURIComponent(args.data.Id)).then(
            response => {
                ...
                const hasRecipients = ("No Recipient" != settings.emailRecipients);
                const recipients = hasRecipients ? settings.emailRecipients.split(",") : [];
                //console.log("hasRecipients",hasRecipients, "recipients", recipients);
                CloverApp.API.setDataField("rs_EmailRecipients",recipients);
    ...
    onClickSave: function (args){
        const emailRecipients = (args.data.rs_EmailRecipients.length > 0)
            ? args.data.rs_EmailRecipients.join(",")
            : "No Recipient";
        const settings = {
            dplyId: args.data.Id,
...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2024-06-17 15:00:32.720', 
[Data]=N'{
  "dataModel": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2024-06-17 11:52:15.777', 
[Data]=N'[
  {
    "key": "container_6",
    "data-buildertype": "container",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2024-06-17 11:52:15.820', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "QNN_DPLY",
  "lastUpdate": "2024-06-17T11:52:15.8198515+08:00",
  "entityId": "95d26a40-bf59-4aef-b578-12b2535f7789",
  "isTemplate": false,
  "triggers": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2024-06-17 11:23:50.810', 
[Data]=N'{
    init: function(args) {
        if(!args.data.Id){
