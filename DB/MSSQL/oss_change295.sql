...
'4d879db0-1a88-4b78-80f7-03229fb983b0', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'RespondentParticipationReport-code.js', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-04-05 13:38:21.357', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-04-06 17:54:51.320', 
N'{
    init: function(args){
    ...
    onExport: function(args) {
        ...
        Utils.postFormRequest("/report/respondentparticipation", formData).then(
            response => {
                let csv = "UID,Respondent Name,Deployment Name,Status,Status Date\n";
                response.item.forEach(function(row) {
                    csv += `${row["uid"]},${row["respName"]},${row["dplyName"]},${row["status"]},${row["statusDate"]}`;
                    csv += "\n";
                });
                ...
                hiddenElement.download = ''RespondentParticipation.csv'';
                hiddenElement.click();
...
'6dbdbfc3-9969-4847-b2a5-3394bfa75853', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'RespondentParticipationReport-settings.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-04-05 12:37:25.483', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-04-06 14:53:49.920', 
N'{
  "isSurvey": false,
  "structDivisionId": "f6e34bdf-b769-42dd-a2be-fee67faf9045",
  "name": "RespondentParticipationReport",
  "lastUpdate": "2022-04-06T14:53:49.9088507+08:00",
  "isTemplate": false,
  "triggers": [],
  "dataMap": [],
  "dataColl": [
...
'ce0356a5-09ff-4fc3-b838-b09ef6c81b8a', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'RespondentParticipationReport.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-04-05 12:37:25.427', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2022-04-06 14:53:49.867', 
N'[
  {
    "key": "header_1",
...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-04-06 15:00:01.950', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "lastUpdate": "2022-04-06T15:00:01.9426718+08:00",
  "isTemplate": false
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-04-06 15:00:01.883', 
[Data]=N'[
  {
    "key": "sidemenu",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-04-06 12:38:45.393', 
[Data]=N'{
  "dataModel": [
    {
