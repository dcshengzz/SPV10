...
-- dplyScheduledExport.json
-- dplyScheduledExport-settings.json
...
'a7b5a24e-4d62-4d29-9390-e47d47dd2c4a', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplyScheduledExport.json', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-07-11 18:55:19.623', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-07-14 12:33:32.560', 
N'[
  {
    "key": "frm_dplyScheduledExport",
    "data-buildertype": "form",
    "children": [
      {
        "key": "header_1",
        "data-buildertype": "header",
        "content": "Scheduled Export Settings",
        "size": "medium"
      },
      {
        "key": "Name",
      ...
      },
      {
        ...
        "children": [
            ...
            "children": [
              {
                ...
                "placeholder": "Select frequency of export",
                "style-width": "300px",
              ...
              {
                "key": "ScheduledExportStartDate",
                "data-buildertype": "input",
                "label": "Date and time to start exports",
                "fluid": true,
                "onChangeTimeout": 200,
                "type": "datetime",
                "placeholder": "Select start date and time",
                "other-customValidation": "!data.ScheduledExportEnabled || (data.ScheduledExportEnabled && value && !isNaN(new Date(value))) ? true : \"Please select a start date\"",
                "events": {},
                "other-required": false
              },
              {
                "key": "ScheduledExportEndDate",
                "data-buildertype": "input",
                "label": "Do not export on or after",
                "fluid": true,
                "onChangeTimeout": 200,
                "type": "date",
                "placeholder": "Select end date",
                "other-customValidation": "!value || (value && new Date(value) > new Date(data.ScheduledExportStartDate)) ? true : \"Must be after the start date\"",
                "events": {}
              },
              {
                "key": "__selectedRecipients",
                "data-buildertype": "staticcontent",
                "content": "__selectedRecipients",
                "style-hidden": true
              },
              {
                "key": "Recipients",
                ...
                "data-elements": [],
                "multiple": true,
                "other-customValidation": "!data.ScheduledExportEnabled || (data.ScheduledExportEnabled && value && value.length>0) ? true : \"Select one or more recipients\""
              },
              {
                "key": "sc_recipientNote",
                "data-buildertype": "staticcontent",
                "content": "Recipients must be in the same organisation as the deployment and have the DataOwner role. Recipients whose account is locked at the time of export will be skipped."
              }
            ],
            "other-visibleConition": "data.ScheduledExportEnabled"
          },
          {
            "key": "container_2",
            "data-buildertype": "container",
          ...
          },
          {
            ...
            "data-buildertype": "formgroup",
            "widths": "equal",
            "other-visibleConition": "data.ScheduledExportJobId",
            "children": [
              {
                "key": "header_2",
                "data-buildertype": "header",
              ...
              {
                "key": "ScheduledExportNextDate",
                "data-buildertype": "input",
                "label": "Next Export Date",
                "fluid": true,
                "onChangeTimeout": 200,
                "type": "datetime",
                "readOnly": true
...
N'{
  ...
  "dataColl": [
    {
      "id": "c2b07597-7923-6776-083f-e635881104d4",
      "entityId": "2440d7d1-2e6f-48b7-b9e1-6c01c3ef7ca1",
      "control": "__selectedRecipients",
      "dataMap": [
        {
          "id": "a3c14bd6-4c7f-11f5-b79b-0b501bcb03e5",
          "attributeId": "1491743c-ef8d-468f-9c10-7d133adbf413",
          "isEditable": true,
          "isLoadable": true
        },
        {
          "id": "2a80fb88-b9af-5b07-e0fb-950602db443f",
          "attributeId": "755e59b8-aff2-404e-a15b-e408909ce99c",
          "isEditable": true,
          "isLoadable": true
        },
        {
          "id": "d4aeb9b1-79d4-05f4-52e3-823976bcce8c",
          "attributeId": "7bd06848-1fe0-434b-b865-402ed82c60cd",
          "isEditable": true,
          "isLoadable": true
        }
      ],
      "readOnly": true,
      "totalCountPropertyName": "____selectedRecipients_totalcount"
    }
  ],
...
'43f69974-3cd4-4b15-9a41-0aa1e252163c', 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 
N'metadata/forms', N'dplyScheduledExport-code.js', 0, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-07-11 19:10:40.683', 
NULL, NULL, 
'b9d69ba9-282b-d3d2-8f23-efc2596a082c', '2023-07-14 12:32:14.433', 
N'{
    init: function(args) {
...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-07-13 11:26:48.427', 
[Data]=N'{
  "dataModel": [
    {
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-07-11 19:21:04.603', 
[Data]=N'[
  {
    "key": "container_6",
    "data-buildertype": "container",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2023-07-11 19:21:04.647', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "QNN_DPLY",
  "lastUpdate": "2023-07-11T19:21:04.647148+08:00",
  "entityId": "95d26a40-bf59-4aef-b578-12b2535f7789",
  "isTemplate": false,
  "triggers": [
    {
