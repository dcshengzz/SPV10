...
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-07-18 18:06:07.883', 
[Data]=N'{
  "isSurvey": false,
  "structDivisionId": "72d461b2-234b-40d6-b410-b261964ba291",
  "name": "QNN_DPLY",
  "lastUpdate": "2022-07-18T18:06:07.8721832+08:00",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-07-18 18:06:07.827', 
[Data]=N'[
  {
    "key": "container_6",
...
[DeletedBy]=NULL, [DeletedDate]=NULL, 
[UpdatedBy]='b9d69ba9-282b-d3d2-8f23-efc2596a082c', [UpdatedDate]='2022-07-18 18:05:42.890', 
[Data]=N'{
    init: function(args) {
        if(!args.data.Id){
                ...
                response => {
                    if(response.success && response.result) {
                        ...
                        response.result.forEach(function(item, index){
                            ...
                            let listItem = ''<li><div style="margin-bottom:16px;">''+item.lang+''&nbsp-&nbsp<span id="link-''+surveyLinkKey+index+''" style="word-break: break-word;">''+item.link +''</span>&nbsp''+iconBtn+''</div></li>'';
                            htmlLink += listItem;
                        });
