  ...
  renderMainForm(){
    ...
    var res = (<div>
        ...
        <GridView key="Formgrid"
            rowKey={this.idfield} rowHeight={rowHeight} columns={this.gridColumns()}
            ...
            filter={this.filter}
            filterAny={this.filterAny}
            ref={(grid)=> { this.grid = grid; }}
        />

        <Modal 
            open={this.state.confirmdeleteshow}
            dimmer={'blurring'}
            ...
            <Modal.Content>
                <Form>
                    <GridView 
                        key="DeleteFormGrid"
                        rowKey="Id" 
                        columns={this.gridColumnsDelete()}
                        value={deleterows}
