...
import GridView from './../../../swz-survey-builder/src/control/gridview'
...
class CssStyleModal extends React.Component {
    ...
    copyCssToClipboard() {
        navigator.clipboard.writeText(this.state.displayCssSelector+'{\n'+this.state.displayCssProperties+'\n}');
    }

    applyCssStyle(){
        this.props.applyActionHandler(this.state.displayCssSelector+'{\n'+this.state.displayCssProperties+'\n}');
        this.close();
    }
    ...
    render() {
       const trigger = 
            <Button 
                className="buttontype2"  style={{float:"right"}}
                onClick={this.open} 
            ...
            <Modal 
                ...
                <Modal.Content>
                    <Form>
                        ...
                        <Form.TextArea 
                            key="displayCssSelector"
                            readOnly={true} 
                            label={this.props.localization.cssSelector} 
                            value={this.state.displayCssSelector} />
                        <Form.TextArea 
