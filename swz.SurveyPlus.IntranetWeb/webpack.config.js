...
var help = {
	mode: 'production',
	cache: true,
    entry: ["./wwwroot/js/app/help.jsx"],
    output: {
        filename: "./../wwwroot/js/help.js"
    },
    module: {
        rules: [
            {
...
var surveyadmin = {
	mode: 'production',
	cache: true,
    entry: ["./wwwroot/js/app/surveyadmin.jsx"],
    output: {
        filename: "./../wwwroot/js/surveyadmin.js"
    },
    module: {
        rules: [
            {
...
var useradmin = {
	mode: 'production',
	cache: true,
    entry: ["./wwwroot/js/app/useradmin.jsx"],
    output: {
        filename: "./../wwwroot/js/useradmin.js"
    },
    module: {
        rules: [
            {
...
module.exports = [ app , surveyadmin, useradmin , admin , login, help ];