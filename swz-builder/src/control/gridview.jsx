...
import CustomRowRenderer from './customrow.jsx'
...
export default class GridView extends React.Component {
    ...
    render() {
        ...
        gridProps.headerRowHeight = 50;

        if (this.props.rowHeight !== undefined && this.props.rowHeight !== "" && this.props.rowHeight !==null && !isNaN(Number(this.props.rowHeight))) {
            gridProps.rowHeight = Number(this.props.rowHeight);
        }

        if (this.props.headerRowHeight && !isNaN(Number(this.props.headerRowHeight))) {
            gridProps.headerRowHeight = Number(this.props.headerRowHeight);            
        }
 
        if (this.props.autoHeight) {
	    style.minHeight = 350;
            if (this.props.minHeight !== undefined && this.props.minHeight !== "" && this.props.minHeight !==null && !isNaN(Number(this.props.minHeight))) {
                style.minHeight = Number(this.props.minHeight);
            }
            ...
            if (this.props.minHeight !== undefined && this.props.minHeight !== "" && this.props.minHeight !==null && !isNaN(Number(this.props.minHeight))) {
                gridProps.minHeight = Number(this.props.minHeight);
            }
        }
	    ...
	    <div key={this.props.name + "_gridcount"} name={this.props.name + "_gridcount"} className="clover-gridview-count"><i class="list icon"></i>{this.state.rowsCount}</div>
        ...
        if (this.props.getAdditionalDataForControl === undefined) {
            ...
            this.props.getAdditionalDataForControl(this,
                ...
                function ({sIndex, pSize, rowsCount, items}) {
                    if (rowsCount === undefined || items === undefined || rowsCount == 0) {
    ...
    componentDidMount() {
        ...
        if (this.grid && this.grid.selectAllCheckbox && this.grid.selectAllCheckbox.id === 'select-all-checkbox') {
            const uniqueNumber = Math.random().toString(16).slice(2);
...
class RowLoadingRenderer extends React.Component {
    ...
    render() {
        return (<div className={this.getClassName()}><CustomRow ref={node => this.row = node} {...this.props}/></div>);
    }
}
